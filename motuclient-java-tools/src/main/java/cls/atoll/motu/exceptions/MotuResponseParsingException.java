...
/**
 * Exception raised when an error occurs when parsing a MOTU response.
 */
@SuppressWarnings("serial")
public class MotuResponseParsingException extends MotuException {

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and
     * may subsequently be initialized by a call to {@link #initCause}.
     */
    public MotuResponseParsingException() {
        super();
    }
     ...
     */
    public MotuResponseParsingException(final String message) {
        super(message);
    }
     ...
     */
    public MotuResponseParsingException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MotuResponseParsingException(final Throwable cause) {
        super(cause);
    }
}

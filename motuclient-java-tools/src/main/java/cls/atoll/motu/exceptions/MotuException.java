...
public class MotuException extends Exception {
     ...
     */
    public MotuException(final String message) {
        super(message);
    }
     ...
     */
    public MotuException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MotuException(final Throwable cause) {
        super(cause);
    }
}

...
public class DownloadServiceRecoverableException extends DownloadServiceException {
     ...
     */
    public DownloadServiceRecoverableException() {
        super();
    }
     ...
     */
    public DownloadServiceRecoverableException(final String message) {
        super(message);
    }
     ...
     */
    public DownloadServiceRecoverableException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public DownloadServiceRecoverableException(final Throwable cause) {
        super(cause);
    }
}

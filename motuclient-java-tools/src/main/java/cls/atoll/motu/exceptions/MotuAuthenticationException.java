...
/**
 * Exception raised when an error occurs with MOTU authentication.
 */
@SuppressWarnings("serial")
public class MotuAuthenticationException extends MotuException {

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and
     * may subsequently be initialized by a call to {@link #initCause}.
     */
    public MotuAuthenticationException() {
        super();
    }
     ...
     */
    public MotuAuthenticationException(final String message) {
        super(message);
    }
     ...
     */
    public MotuAuthenticationException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MotuAuthenticationException(final Throwable cause) {
        super(cause);
    }
}

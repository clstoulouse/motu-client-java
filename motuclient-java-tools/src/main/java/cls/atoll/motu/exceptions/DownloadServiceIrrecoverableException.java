package cls.atoll.motu.exceptions;

/**
 * Exception raised by a download service for a irrecoverable error (when a retry cannot solve the issue).
 */
@SuppressWarnings("serial")
public class DownloadServiceIrrecoverableException extends DownloadServiceException {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and
     * may subsequently be initialized by a call to {@link #initCause}.
     */
    public DownloadServiceIrrecoverableException() {
        super();
    }
     ...
     */
    public DownloadServiceIrrecoverableException(final String message) {
        super(message);
    }
     ...
     */
    public DownloadServiceIrrecoverableException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public DownloadServiceIrrecoverableException(final Throwable cause) {
        super(cause);
    }
}

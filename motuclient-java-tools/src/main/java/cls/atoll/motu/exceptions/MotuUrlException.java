...
/**
 * Exception raised when an error occurs when manipulating MOTU urls.
 */
@SuppressWarnings("serial")
public class MotuUrlException extends MotuException {

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and
     * may subsequently be initialized by a call to {@link #initCause}.
     */
    public MotuUrlException() {
        super();
    }
     ...
     */
    public MotuUrlException(final String message) {
        super(message);
    }
     ...
     */
    public MotuUrlException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MotuUrlException(final Throwable cause) {
        super(cause);
    }
}

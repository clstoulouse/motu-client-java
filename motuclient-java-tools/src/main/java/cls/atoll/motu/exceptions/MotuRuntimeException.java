...
public class MotuRuntimeException extends RuntimeException {
     ...
     */
    public MotuRuntimeException(final String message) {
        super(message);
    }
     ...
     */
    public MotuRuntimeException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MotuRuntimeException(final Throwable cause) {
        super(cause);
    }
}
